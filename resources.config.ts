...
export const SERVICES: ServiceResources[] = [
  ...
  },
  {
    ...
    r2: [
      { name: "crow-core-interaction-service-store-local", env: "local" },
  ...
  },
  {
    ...
    r2: [
      { name: "crow-core-notification-service-store-local", env: "local" },
  ...
  },
  {
    ...
    r2: [
      { name: "crow-core-organization-service-store-local", env: "local" },
  ...
  },
  {
    ...
    r2: [
      { name: "crow-core-pattern-service-store-local", env: "local" },
  ...
  },
  {
    ...
    r2: [
      { name: "crow-core-product-service-store-local", env: "local" },
  ...
  },
  {
    ...
    r2: [
      { name: "crow-core-user-service-store-local", env: "local" },
  ...
  },
  {
    ...
    r2: [
      { name: "crow-mcp-service-store-local", env: "local" },
